...
%% 下面对2009-2018年东部地区固定资产投资进行预测
% 使用三次指数平滑法模型进行短期预测

yt = xlsread('2009-2018年东部地区指标汇总.xlsx');
yt = yt(3,:)'; %导入2009-2018年东部地区固定资产投资
...
st3(1) = alpha*st2(1)+(1-alpha)*st0;
 ...
 ct = 0.5*alpha^2/(1-alpha)^2*(st1-2*st2+st3);
 yhat = at+bt+ct;
 xlswrite('固定资产投资预测.xls',[st1',st2',st3'],'Sheet1','B2') %把数据写在前三列
 xlswrite('固定资产投资预测.xls',yhat','Sheet1','E3');%把数据写在第4列第2行开始的位置
